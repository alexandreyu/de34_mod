...
public final class ItemInit {
	...
	public static final RegistryObject<BucketItem> OIL_BUCKET = ITEMS.register("oil_bucket",
			() -> new BucketItem(FluidInit.OIL, (new Item.Properties()).stacksTo(1).tab(DE34M.DE34_TAB)));

	public static final RegistryObject<Item> ELERIUM_SHARD = ITEMS.register("elerium_shard",
			() -> new Item(new Item.Properties().tab(DE34M.DE34_TAB).fireResistant().stacksTo(16)));
	...
	public static final RegistryObject<Item> ACTIVATED_ELERIUM = ITEMS.register("activated_elerium",
			() -> new Item(new Item.Properties().tab(DE34M.DE34_TAB).stacksTo(16)));
	...
	public static final RegistryObject<BlockItem> OIL_ORE_BLOCK_ITEM = ITEMS.register("oil_ore",
			() -> new BlockItem(BlockInit.OIL_ORE.get(), new Item.Properties().tab(DE34M.DE34_TAB)));
	...
	public static final RegistryObject<BlockItem> ELERIUM_BLOCK_ITEM = ITEMS.register("elerium_block",
			() -> new BlockItem(BlockInit.ELERIUM_BLOCK.get(), new Item.Properties().tab(DE34M.DE34_TAB)));

	// Composites
	public static final RegistryObject<BlockItem> TUNGSTEN_CARBIDE_BLOCK_ITEM = ITEMS.register("tungsten_carbide_block",
			() -> new BlockItem(BlockInit.TUNGSTEN_CARBIDE_BLOCK.get(), new Item.Properties().tab(DE34M.DE34_TAB)));

	public static final RegistryObject<BlockItem> STEEL_BLOCK_ITEM = ITEMS.register("steel_block",
			() -> new BlockItem(BlockInit.STEEL_BLOCK.get(), new Item.Properties().tab(DE34M.DE34_TAB)));

	public static final RegistryObject<BlockItem> DARK_STEEL_BLOCK_ITEM = ITEMS.register("black_steel_block",
			() -> new BlockItem(BlockInit.BLACK_STEEL_BLOCK.get(), new Item.Properties().tab(DE34M.DE34_TAB)));

	public static final RegistryObject<BlockItem> WCR_BLOCK_ITEM = ITEMS.register("wcr_block",
			() -> new BlockItem(BlockInit.WCR_BLOCK.get(), new Item.Properties().tab(DE34M.DE34_TAB)));

	public static final RegistryObject<BlockItem> CHROMIUM_CARBIDE_BLOCK_ITEM = ITEMS.register("chromium_carbide_block",
			() -> new BlockItem(BlockInit.CHROMIUM_CARBIDE_BLOCK.get(), new Item.Properties().tab(DE34M.DE34_TAB)));

	public static final RegistryObject<BlockItem> ACTIVATED_ELERIUM_BLOCK = ITEMS.register("activated_elerium_block",
			() -> new BlockItem(BlockInit.ACTIVATED_ELERIUM_BLOCK.get(), new Item.Properties().tab(DE34M.DE34_TAB)));

	// Special
	public static final RegistryObject<BlockItem> HIGH_TEMPERATURE_FURNACE_BLOCK_ITEM = ITEMS.register(
			"high_temperature_furnace",
			() -> new BlockItem(BlockInit.HIGH_TEMPERATURE_FURNACE.get(), new Item.Properties().tab(DE34M.DE34_TAB)));

	public static final RegistryObject<BlockItem> GAMMA_ACTIVATOR_BLOCK_ITEM = ITEMS.register("gamma_activator",
			() -> new BlockItem(BlockInit.GAMMA_ACTIVATOR.get(), new Item.Properties().tab(DE34M.DE34_TAB)));

	public static final RegistryObject<BlockItem> CROWN_BLOCK_ITEM = ITEMS.register("crown",
			() -> new BlockItem(BlockInit.CROWN.get(), new Item.Properties().tab(DE34M.DE34_TAB)));

	public static final RegistryObject<BlockItem> PHASED_ELERIUM_BLOCK_ITEM = ITEMS.register("phased_elerium_block",
			() -> new BlockItem(BlockInit.PHASED_ELERIUM_BLOCK.get(), new Item.Properties().tab(DE34M.DE34_TAB)));

	// Equipment
	public static final RegistryObject<SwordItem> BLACK_STEEL_SWORD = ITEMS.register("black_steel_sword",
			() -> new SwordItem(ToolMaterialInit.BLACK_STEEL_TIER, 4, 1f, new Item.Properties().tab(DE34M.DE34_TAB)));
	...
	public static final RegistryObject<PickaxeItem> TUNGSTEN_CARBIDE_PICKAXE = ITEMS
			.register("tungsten_carbide_pickaxe", () -> new PickaxeItem(ToolMaterialInit.TUNGSTEN_CARBIDE_TIER, 5, 1f,
					new Item.Properties().tab(DE34M.DE34_TAB)));
	...
	public static final RegistryObject<ShovelItem> WCR_SHOVEL = ITEMS.register("wcr_shovel",
			() -> new ShovelItem(ToolMaterialInit.WCR_TIER, 2, 1f, new Item.Properties().tab(DE34M.DE34_TAB)));

	public static final RegistryObject<SteelBowItem> STEEL_BOW = ITEMS.register("steel_bow",
			() -> new SteelBowItem(new Item.Properties().tab(DE34M.DE34_TAB).stacksTo(1)));
