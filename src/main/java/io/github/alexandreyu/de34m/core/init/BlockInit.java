...
public final class BlockInit {
	...
	public static final RegistryObject<LiquidBlock> OIL = BLOCKS.register("oil", () -> new LiquidBlock(FluidInit.OIL,
			BlockBehaviour.Properties.of(Material.WATER).strength(100.0F)));
