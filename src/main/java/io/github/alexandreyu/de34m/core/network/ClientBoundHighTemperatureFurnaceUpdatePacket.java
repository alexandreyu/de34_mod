...
public class ClientBoundHighTemperatureFurnaceUpdatePacket {
	public final BlockPos furnacePos;

	public ClientBoundHighTemperatureFurnaceUpdatePacket(BlockPos pos) {
		this.furnacePos = pos;
	}

	public ClientBoundHighTemperatureFurnaceUpdatePacket(FriendlyByteBuf buffer) {
