...
import io.github.alexandreyu.de34m.common.item.RefelxItem;
import io.github.alexandreyu.de34m.common.item.SteelBowItem;
import io.github.alexandreyu.de34m.common.item.TokenItem;
...
public final class ItemInit {
	...
	public static final RegistryObject<BlockItem> CHROMIUM_BLOCK_ITEM = ITEMS.register("chromium_block",
			() -> new BlockItem(BlockInit.CHROMIUM_BLOCK.get(),
	...
	public static final RegistryObject<BlockItem> TUNGSTEN_BLOCK_ITEM = ITEMS.register("tungsten_block",
			() -> new BlockItem(BlockInit.TUNGSTEN_BLOCK.get(),
					new Item.Properties().tab(DE34M.DE34_TAB).fireResistant().rarity(Rarity.UNCOMMON)));

	public static final RegistryObject<BlockItem> OIL_BARREL_BLOCK_ITEM = ITEMS.register("oil_barrel",
			() -> new BlockItem(BlockInit.OIL_BARREL.get(),
					new Item.Properties().tab(DE34M.DE34_TAB).rarity(Rarity.UNCOMMON)));
	...
	public static final RegistryObject<TokenItem> TOKEN = ITEMS.register("token", () -> new TokenItem(
			new Item.Properties().tab(DE34M.DE34_TAB).fireResistant().rarity(RarityInit.LEGENDARY)));

	public static final RegistryObject<SwordItem> BAD_PLAYER_NO_COOKIE = ITEMS.register("bad_player_no_cookie",
			() -> new SwordItem(ToolMaterialInit.LOL_TIER, 791, 96f,
					new Item.Properties().tab(DE34M.DE34_TAB).rarity(RarityInit.FORBIDDEN)));

	public static RegistryObject<RefelxItem> REFELX = ITEMS.register("refelx",
			() -> new RefelxItem(new Item.Properties().tab(DE34M.DE34_TAB).rarity(RarityInit.FORBIDDEN)));
